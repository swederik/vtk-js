...
import vtkSVGCrosshairsWidget from 'vtk.js/Sources/Widgets/SVG/SVGCrosshairsWidget';
...
const distWidget = vtkSVGCrosshairsWidget.newInstance();
...
widgetProp.set2DCallback(({ startPoint2D, endPoint2D, distance }) => {
  distWidget.setPoint(startPoint2D);
  svgWidgetManager.render();
});
